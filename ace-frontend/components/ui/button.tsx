  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-semibold transition-colors disabled:pointer-events-none disabled:opacity-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        outlineDanger: "bg-transparent text-destructive border border-destructive/30 hover:bg-destructive/5",
        danger: "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        ghost: "bg-transparent text-muted-foreground hover:bg-secondary",
        icon: "bg-transparent text-foreground hover:bg-secondary rounded-full",
      },
      size: {
        default: "h-12 px-5 w-full",
        sm: "h-9 px-3.5 text-[13px] w-auto rounded-lg",
        icon: "h-9 w-9 p-0",
      },
    },
    defaultVariants: {
